...
❥ our channel : @ActionTG
]]
,
helplock = [[
•• * The main lock Guide *: ツ
...
,
helpsetlink = [[
•• *Instruction Set and get links Group* : ツ
...
,
helpprodemo = [[
•• * A Manager's Guide to Promotion or dismissal as a user *: ツ
...
,
helpfun = [[
•• * Fun Capability & Public Commands Guide *: ツ
